...
export const register = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      text: `welcome to Google your account has been successfully created with email id:${email}`,
    };
...
export const login = async (req, res) => {
  ...
  try {
    ...
    if (!isMatch) {
      return res.json({ success: false, message: "invald password" });
    }
...
export const sendVerifyOtp = async (req, res) => {
  try {
    ...
    const mailOption = {
      ...
      // text: `  OTP for verifiying your email is: ${otp}`,
...
export const sendResetOtp = async (req, res) => {
  ...
  try {
    ...
    const mailOption = {
      ...
      //text: `Your OTP for password rest is ${otp}`,
